...
failure; with the timeout, every handshake fails, so nextserver walks through every server in the catalogue and nomination lists until they are exhausted, and all of them are tried on each message. Therefore, the volume of Run~3 (57{,}937 frames,
...
per attempt across four servers in 681 messages.
